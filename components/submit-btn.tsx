...
export default function SubmitBtn() {
    ...
    return (
        <button
            ...
            transition-all focus:scale-110 hover:scale-110 active:scale-105 cursor-pointer hover:bg-gray-950
            disabled:scale-100 disabled:opacity-65 dark:bg-white/10">
            {
